...
## Modul indstillinger
**customRefForAll** [true/false] Hvis true ignoreres inputrefs og VirStrain subtypering og alle fastsqfiler bliver kun alignet til de(n) reference(r) der er angivet i cRef (se nedenstående).
