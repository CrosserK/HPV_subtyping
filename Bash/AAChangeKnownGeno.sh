...
# Henter options
Options=$(grep -v "^#" /home/pato/Skrivebord/HPV16_projekt/FindAAChange_wKnownGenotypes_Options.txt)

Name=$(grep "Name=" <<< $Options | sed 's/Name=//g')
...
do
	...
	AlignAndVariantCallFromCovGenotyping.sh $FastqRunInput $FastqInput $SuperRunName $MainF $GenoTypeCallIn $BedFileNameX $AmpliconRef
